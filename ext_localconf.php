...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['tslib/class.tslib_content.php']['stdWrap'][$_EXTKEY] = \TYPO3\CMS\FrontendEditing\Hooks\EditIcons::class; // 'EXT:pxa_feediting/Classes/Hooks/EditIcons.php:&EditIcons';
