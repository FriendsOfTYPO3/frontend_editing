...
define(
  ...
  function TranslatorLoader($, createTranslatorFactory, Logger) {
    ...
    var fallbackTranslation = {
      ...
      'notifications.unsaved-changes-title': 'Do you want to continue without saving?',
      'notifications.unsaved-changes-Message': 'You currently have unsaved changes. Are you sure you want to discard these changes?',
      'notifications.unsaved-changes-save-and-go-ahead': 'Save and go ahead',
      'notifications.unsaved-changes-discard-changes': 'Yes, Discard my changes',
      'notifications.unsaved-changes-continue-editing': 'No, I will continue editing',
      ...
      'notifications.navigate-with-ctrl': 'To navigate, hold down the CTRL key and click on the link',
    ...
    var defaultNamespaceMapping = {
      ...
      editor: {
        ...
        informNavigateWithCtrl: 'notifications.navigate-with-ctrl'
      },
      gui: {
